...
/***/ function(module, exports, __webpack_require__) {
	...
	function subscribe(id, eventType, fn) {
		emitter.on(eventType, function (controlId) {
			if (id === controlId) {
				fn();
			}
		});
	...
	function makeControl(opts) {
		var typeProps = typesMap[opts.type];
	...
	function clicked(id) {
		var _actions = Object.create(actions);
		subscribe(id, "clicked", function () {
